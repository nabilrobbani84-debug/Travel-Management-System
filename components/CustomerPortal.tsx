...
export function CustomerPortal({
  ...
  return (
    <div className="space-y-6">
      ...
      {activeSubTab === 'EXPLORE' && (
        <>
          {/* Parallax Luxury Hero Banner with Search & Live Engine Indicators */}
          <div className="relative rounded-3xl overflow-hidden text-white p-8 sm:p-12 shadow-2xl border border-slate-800/80 bg-mesh-dark glow-blue">
            {/* Parallax Image & Gradient Backdrop Overlay */}
            <div className="absolute inset-0 opacity-30 mix-blend-overlay scale-105 hover:scale-100 transition-transform duration-1000 ease-out">
              <img
            ...
            {/* Glowing Accent Orbs */}
            <div className="absolute -top-24 -right-24 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl pointer-events-none animate-pulse-glow" />
            <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-indigo-500/20 rounded-full blur-3xl pointer-events-none animate-float-delayed" />

            <div className="relative z-10 max-w-3xl space-y-4">
              <div className="flex flex-wrap items-center gap-2">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-blue-500/30 text-blue-200 border border-blue-400/40 backdrop-blur-md glow-blue">
                ...
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-500/20 text-emerald-300 border border-emerald-400/30 backdrop-blur-md">
                  ...
                  100% Atomic Concurrency Lock Active
                </span>
              </div>

              <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-white leading-tight drop-shadow-md">
                Jelajahi Keindahan Nusantara <br className="hidden sm:block" />
                <span className="bg-gradient-to-r from-blue-400 via-indigo-300 to-sky-400 bg-clip-text text-transparent">
                  Pengalaman Luxury Tak Tertandingi
                </span>
              </h1>

              <p className="text-slate-300 text-xs sm:text-base max-w-2xl leading-relaxed">
                Sistem reservasi terenkapsulasi real-time bergaransi kuota atomic lock, resor bintang 5 terpilih, pemandu lokal bersertifikasi, serta Faktur Pajak otomatis.
              </p>
            </div>

            {/* Floating Glassmorphic Quick Filter Bar */}
            <div className="relative z-10 mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3 glass-card-dark p-3.5 rounded-2xl border border-white/20 shadow-2xl">
              <div className="flex items-center gap-2.5 bg-white/95 rounded-xl px-3.5 py-2.5 text-slate-800 shadow-inner group focus-within:ring-2 focus-within:ring-blue-500 transition">
                <Search className="w-4 h-4 text-blue-600 shrink-0 group-focus-within:scale-110 transition-transform" />
                <input
                  type="text"
                  placeholder="Cari paket, destinasi, atau kota..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full text-xs outline-hidden font-semibold placeholder:text-slate-400 bg-transparent text-slate-900"
                />
              </div>

              <div className="flex items-center gap-2.5 bg-white/95 rounded-xl px-3.5 py-2.5 text-slate-800 shadow-inner group focus-within:ring-2 focus-within:ring-blue-500 transition">
                <MapPin className="w-4 h-4 text-indigo-600 shrink-0 group-focus-within:scale-110 transition-transform" />
                <select
                  value={selectedDestination}
                  onChange={(e) => setSelectedDestination(e.target.value)}
                  className="w-full text-xs outline-hidden font-semibold text-slate-800 bg-transparent cursor-pointer"
                >
              ...
              <div className="flex items-center gap-2.5 bg-white/95 rounded-xl px-3.5 py-2.5 text-slate-800 shadow-inner">
                <Calendar className="w-4 h-4 text-emerald-600 shrink-0" />
                <span className="text-xs font-semibold text-slate-700 truncate">
                  Jadwal 2026 Ready & Guaranteed
                </span>
              </div>
            </div>
          </div>

          {/* Luxury Feature Parallax Showcase Bar */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 hover:-translate-y-1 flex items-center gap-3">
              <div className="p-2.5 rounded-xl bg-blue-50 text-blue-600 font-bold">
                <ShieldAlert className="w-5 h-5" />
              </div>
              <div>
                <div className="text-xs font-extrabold text-slate-900">Atomic Lock</div>
                <div className="text-[10px] text-slate-500">Bebas Overbooking</div>
              </div>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 hover:-translate-y-1 flex items-center gap-3">
              ...
              <div>
                <div className="text-xs font-extrabold text-slate-900">Hotel Bintang 5</div>
                <div className="text-[10px] text-slate-500">Resor Terpilih</div>
              </div>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 hover:-translate-y-1 flex items-center gap-3">
              ...
              <div>
                <div className="text-xs font-extrabold text-slate-900">Faktur Pajak</div>
                <div className="text-[10px] text-slate-500">Invoice Otomatis</div>
              </div>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 hover:-translate-y-1 flex items-center gap-3">
              ...
              <div>
                <div className="text-xs font-extrabold text-slate-900">24/7 Concierge</div>
                <div className="text-[10px] text-slate-500">Dukungan Responsif</div>
              </div>
            </div>
          </div>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-bold whitespace-nowrap transition-all duration-300 ${
                  selectedCategory === cat.id
                    ? 'bg-slate-900 text-white shadow-md glow-blue scale-105'
